...
_$DeviceModelImpl _$$DeviceModelImplFromJson(Map<String, dynamic> json) =>
    _$DeviceModelImpl(
      ...
      devLon: const SafeDoubleConverter().fromJson(json['dev_lon']),
      devLat: const SafeDoubleConverter().fromJson(json['dev_lat']),
      devAlt: const SafeDoubleConverter().fromJson(json['dev_alt']),
      ...
      devCreated: json['dev_created'] == null
          ? null
          : DateTime.parse(json['dev_created'] as String),
      devUpdate: json['dev_update'] == null
          ? null
          : DateTime.parse(json['dev_update'] as String),
    );
...
Map<String, dynamic> _$$DeviceModelImplToJson(_$DeviceModelImpl instance) =>
    <String, dynamic>{
      ...
      'dev_lon': const SafeDoubleConverter().toJson(instance.devLon),
      'dev_lat': const SafeDoubleConverter().toJson(instance.devLat),
      'dev_alt': const SafeDoubleConverter().toJson(instance.devAlt),
      ...
      'dev_created': instance.devCreated?.toIso8601String(),
      'dev_update': instance.devUpdate?.toIso8601String(),
    };
