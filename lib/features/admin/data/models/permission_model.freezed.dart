...
mixin _$PermissionModel {
  ...
  @JsonKey(name: 'perm_slug')
  String? get permSlug => throw _privateConstructorUsedError;
...
abstract class $PermissionModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'perm_slug') String? permSlug,
      ...
      _value.copyWith(
            ...
            permName: freezed == permName
                ...
                : permName // ignore: cast_nullable_to_non_nullable
                      as String?,
            permSlug: freezed == permSlug
                ? _value.permSlug
                : permSlug // ignore: cast_nullable_to_non_nullable
                      as String?,
...
class _$PermissionModelImpl extends _PermissionModel {
  const _$PermissionModelImpl({
    ...
    @JsonKey(name: 'perm_slug') this.permSlug,
  ...
  @override
  String toString() {
    return 'PermissionModel(permId: $permId, permName: $permName, permSlug: $permSlug, permDesc: $permDesc, permPage: $permPage, permSts: $permSts, permCreated: $permCreated, permUpdate: $permUpdate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.permSlug, permSlug) ||
                other.permSlug == permSlug) &&
...
abstract class _PermissionModel extends PermissionModel {
  const factory _PermissionModel({
    ...
    @JsonKey(name: 'perm_slug') final String? permSlug,
