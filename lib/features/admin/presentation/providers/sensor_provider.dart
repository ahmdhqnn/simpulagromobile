...
// REPOSITORY PROVIDER
// ═══════════════════════════════════════════════════════════
final adminSensorRepositoryProvider = Provider<SensorRepository>((ref) {
  final datasource = ref.watch(adminSensorRemoteDatasourceProvider);
...
// ═══════════════════════════════════════════════════════════
final adminSensorListProvider = FutureProvider<List<Sensor>>((ref) async {
  final repository = ref.watch(adminSensorRepositoryProvider);
...
// ═══════════════════════════════════════════════════════════
final adminSensorDetailProvider = FutureProvider.family<Sensor, String>((
  ref,
  sensorId,
) async {
  final repository = ref.watch(adminSensorRepositoryProvider);
...
class SensorFormNotifier extends StateNotifier<SensorFormState> {
  ...
  Future<bool> createSensor(Sensor sensor) async {
    ...
    try {
      ...
      _ref.invalidate(adminSensorListProvider);
  ...
  Future<bool> updateSensor(String sensorId, Sensor sensor) async {
    ...
    try {
      ...
      _ref.invalidate(adminSensorListProvider);
      _ref.invalidate(adminSensorDetailProvider(sensorId));
