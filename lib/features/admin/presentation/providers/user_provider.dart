...
// DATASOURCE PROVIDER
// ═══════════════════════════════════════════════════════════
final adminUserRemoteDatasourceProvider = Provider<UserRemoteDatasource>((ref) {
...
final adminUserRepositoryProvider = Provider<UserRepository>((ref) {
  final datasource = ref.watch(adminUserRemoteDatasourceProvider);
...
// ═══════════════════════════════════════════════════════════
final adminUserDetailProvider = FutureProvider.family<User, String>((
  ref,
  userId,
) async {
  final repository = ref.watch(adminUserRepositoryProvider);
...
class UserFormNotifier extends StateNotifier<UserFormState> {
  ...
  Future<bool> createUser(User user, String password) async {
    ...
    try {
      ...
      _ref.invalidate(adminUserListProvider);
      return true;
    } catch (e) {
