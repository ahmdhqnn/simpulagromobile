...
import 'package:simpulagromobile/features/utilitas/presentation/widgets/device_sensors/async_dropdown_widget.dart';
import 'package:simpulagromobile/features/utilitas/presentation/widgets/device_sensors/threshold_row_widget.dart';
...
class _DeviceSensorFormScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final notifier = ref.read(deviceSensorFormProvider.notifier);
      ...
      child: Column(
        children: [
          ...
          AsyncDropdownWidget<dynamic, String>(
            async: ref.watch(utilitasDeviceListProvider),
          ...
          SizedBox(height: context.rh(0.016)),
          AsyncDropdownWidget<dynamic, String>(
            async: ref.watch(utilitasSensorListProvider),
          ...
          SizedBox(height: context.rh(0.016)),
          AsyncDropdownWidget<dynamic, String>(
            async: ref.watch(utilitasUnitListProvider),
