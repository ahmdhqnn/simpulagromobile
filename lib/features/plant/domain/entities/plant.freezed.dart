...
class _$PlantImpl extends _Plant {
  ...
  @override
  String toString() {
    return 'Plant(plantId: $plantId, siteId: $siteId, varietasId: $varietasId, plantName: $plantName, plantType: $plantType, plantSpecies: $plantSpecies, plantDate: $plantDate, plantHarvest: $plantHarvest, plantSts: $plantSts)';
  }
