...
class _$DeviceModelImpl extends _DeviceModel {
  const _$DeviceModelImpl({
    ...
    @JsonKey(name: 'sensor') final List<SensorModel>? sensors,
  }) : _sensors = sensors,
       super._();
  ...
  @override
  String toString() {
    return 'DeviceModel(devId: $devId, siteId: $siteId, userId: $userId, devName: $devName, devToken: $devToken, devLocation: $devLocation, devLon: $devLon, devLat: $devLat, devAlt: $devAlt, devNumberId: $devNumberId, devIp: $devIp, devPort: $devPort, devImg: $devImg, devSts: $devSts, sensors: $sensors)';
  }
